...
for slice = 0:Nimages-1
    ...
    fullFileName = fullfile('D:/Geena/For Maziar/ConnectedDroplets/stitched/0.75/Images',a);     
    ...
    b = ['Thin','.tif'];
    file = fullfile('D:/Geena/For Maziar/ConnectedDroplets/stitched/0.75/Images',b);
