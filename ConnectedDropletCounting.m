...
pathway = 'D:/Geena/for Maziar/ConnectedDroplets/DMSO June 14/0.5dmso/Series011GaussianConnectivity.xlsx';
...
fullFileName_S = fullfile('ConnectedDroplets','DMSO June 14','0.5dmso','NewImages', S);
thisSlice_S = imread(fullFileName_S);
array_S(:,:,slice+1) = thisSlice_S;

fullFileName_D = fullfile('ConnectedDroplets','DMSO June 14','0.5dmso','NewImages', D);
